...
void btm_acl_update_busy_level (tBTM_BLI_EVENT event)
{
    ...
    //terrence,2014/12/24,WCNCR00004986,fixed bug,critical status should be updated 
    //if (busy_level != btm_cb.busy_level)
	if ((event == BTM_BLI_INQ_EVT)  || (event == BTM_BLI_INQ_CANCEL_EVT) || (busy_level != btm_cb.busy_level))
    {
