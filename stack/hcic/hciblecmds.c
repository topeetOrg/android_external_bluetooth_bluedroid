                                       ...
                                       UINT16 min_ce_len, UINT16 max_ce_len)
{
	...
	//default value change for HID devices
	if ((conn_int_min == 0x06) && (conn_int_max == 0x06))  
	{
		conn_int_min = 0x14; //40 slots
		conn_int_max = 0x18; //48 slots
	}

	if ((min_ce_len == 0) && (max_ce_len == 0))
	{
		min_ce_len = 0x60;
		max_ce_len = 0x140;
	}
